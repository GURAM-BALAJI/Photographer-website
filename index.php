        ...
        <div class="container">
            <div class="row">
                ...
                <div class="mt-lg-0 mb-lg-0 mb-4 col-lg-5 col-md-10 mx-auto col-12">
                    <h2 class="mb-2" data-aos="fade-up" data-aos-delay="300">Welcome to Deepak Studio</h2>

                    <p data-aos="fade-up" data-aos-delay="400">
                        where reality is captured and treasured through the eyes of lenses. We make
                        life roll over reels every time you look back. Moments pass with
                        time but our pictures, videos will always urge you to go back and
                        revisit them allowing you to clear up the dust left by time on the
                        book of your memories.</p>
                    <p data-aos="fade-up" data-aos-delay="500"> As Memories are like wine – the more you
                        preserve them, the more toast it adds to life.</p>

                </div>

                <div class="ml-lg-auto col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-delay="700">
                    <div class="team-thumb">
                        <img src="images/info/photo.jpg" class="img-fluid" alt="Trainer">
                ...
                <div class="col-lg-3 col-md-6 col-12" data-aos="fade-up"
                    data-aos-delay="800">
                    <div class="team-thumb">
                        <img src="images/info/video.jpg" class="img-fluid" alt="Trainer">
                        <div class="team-info d-flex flex-column">
                            <h3>videography</h3>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Wedding Photography</h3>
                        </div>
                    </div>
                </div>

                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="500">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Candid Photo & Video</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Cinematography</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Corporate Events</h3>
                        </div>
                    </div>
                </div>
                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="600">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Pre Wedding & Post Wedding Shoot</h3>
                        </div>
                    </div>
                </div>
                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="600">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Comercial Photo & Video</h3>
                        </div>
                    </div>
                </div>
                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Out door Photo & Videography</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="500">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Photo Lamination</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="600">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Photo Framing</h3>
                        </div>
                    </div>
                </div>
                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Digital Album</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="500">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Video Editing</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="600">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Short Film Shoot & Editing</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="600">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Mug prints & Gift items</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-2 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Calender With Photo</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-2  col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="500">
                    <div class="class-thumb">
                        <div class="class-info">
                            <h3 class="mb-1">Mobile Photo Printing</h3>
                        </div>
                    </div>
                </div>
