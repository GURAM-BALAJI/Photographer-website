...
<body data-spy="scroll" data-target="#navbarNav" data-offset="50">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-lg-auto">
                    ...
                    <li class="nav-item">
                        <a href="video.php" class="nav-link active smoothScroll">Videos</a>
                    </li>
    ...
    <section class="class section">
        <div class="container">
            <div class="row">
                <div class="mt-4 col-lg-12 col-12 text-center mb-2">
                    <article class="video" data-aos="fade-up" data-aos-delay="400">
                        <figure>
                            <a class="fancybox fancybox.iframe" href="//www.youtube.com/embed/5OjLEiDKz5M">
                                <img class="videoThumb" src="//i1.ytimg.com/vi/5OjLEiDKz5M/mqdefault.jpg"></a>
                        </figure>
                        <h2 class="videoTitle">Mesopotamia</h2>
                    </article>

                    <article class="video" data-aos="fade-up" data-aos-delay="500">
                        <figure>
                            <a class="fancybox fancybox.iframe" href="//www.youtube.com/embed/5OjLEiDKz5M">
                                <img class="videoThumb" src="//i1.ytimg.com/vi/5OjLEiDKz5M/mqdefault.jpg"></a>
                        </figure>
                    ...
                    <article class="video" data-aos="fade-up" data-aos-delay="600">
                        <figure>
                            <a class="fancybox fancybox.iframe" href="//www.youtube.com/embed/5OjLEiDKz5M">
                                <img class="videoThumb" src="//i1.ytimg.com/vi/5OjLEiDKz5M/mqdefault.jpg"></a>
                        </figure>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="ml-auto col-lg-5 col-md-6 col-12">
                    <h2 class="text-white mb-4 pb-2" data-aos="fade-up" data-aos-delay="200">Feel free to ask anything
                    </h2>
                    ...
                    <form action="#" method="post" class="contact-form webform" data-aos="fade-up" data-aos-delay="400"
                        ...
                        <button type="submit" class="form-control" id="submit-button" name="submit"
                            style="background-color: red;">Send
                            Message</button>
                    </form>
                </div>

                <div class="mx-auto mt-4 mt-lg-0 mt-md-0 col-lg-5 col-md-6 col-12">
                    <h2 class="text-white mb-4" data-aos="fade-up" data-aos-delay="500">Where you can <span>find
                            us</span></h2>

                    <p class="text-white" data-aos="fade-up" data-aos-delay="600"><i class="fa fa-map-marker mr-1"></i>
                        120-240 Rio de
                        Janeiro - State of Rio de Janeiro, Brazil</p>
                    <p class="text-white" data-aos="fade-up" data-aos-delay="700">
                        <i class="fa fa-phone mr-1"></i> +91 90353-76766
                    </p>
                    <p class="text-white" data-aos="fade-up" data-aos-delay="800">
                        <i class="fa fa-envelope-o mr-1"></i>
                        <a>support@7SoftSolution.com</a>
                    <p>
