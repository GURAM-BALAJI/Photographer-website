            ...
            <div class="container">
                <div class="row">
                    <div class="mt-4 col-lg-12 col-12 text-center mb-2">
                        <?php
                        $stmt_images = $conn->prepare("SELECT * FROM video_gallery");
                        $stmt_images->execute();
                        foreach ($stmt_images as $row_images) { ?>
                            <article class="video" data-aos="fade-up" data-aos-delay="400">
                                <figure>
                                    <a class="fancybox fancybox.iframe" href="//www.youtube.com/embed/<?php echo $row_images['video_gallery_link']; ?>">
                                        <img class="videoThumb" src="//i1.ytimg.com/vi/<?php echo $row_images['video_gallery_link']; ?>/mqdefault.jpg"></a>
                                </figure>
                                <h2 class="videoTitle"><?php echo $row_images['video_gallery_name']; ?></h2>
                            </article>
                        <?php } ?>
                    </div>
                </div>
